...
//! ```ignore, ignore_snippet: the crate-level glue macros. Their trait impls are crate-scoped, so a harness holding two invocations is a duplicate-impl error by construction.
//! mod bindings {
